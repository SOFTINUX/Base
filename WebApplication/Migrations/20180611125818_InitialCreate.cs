        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(maxLength: 20, nullable: false),
                    LastName = table.Column<string>(maxLength: 20, nullable: false),
                    Compagny = table.Column<string>(maxLength: 80, nullable: true),
                    Address = table.Column<string>(maxLength: 70, nullable: true),
                    City = table.Column<string>(maxLength: 40, nullable: true),
                    State = table.Column<string>(maxLength: 40, nullable: true),
                    Country = table.Column<string>(maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaylistTrack", x => x.PlaylistId);
                    table.UniqueConstraint("AK_PlaylistTrack_TrackId", x => x.TrackId);
                    table.UniqueConstraint("AK_PlaylistTrack_PlaylistId_TrackId", x => new { x.PlaylistId, x.TrackId });
                    table.ForeignKey(
