...
namespace SoftinuxBase.Security.AuthorizeSetup
{
    ...
    public class AddPermissionsToUserClaims : UserClaimsPrincipalFactory<User>
    {
        private readonly ApplicationStorageContext _extraAuthDbContext;

        public AddPermissionsToUserClaims(UserManager<User> userManager_, IOptions<IdentityOptions> optionsAccessor_,
