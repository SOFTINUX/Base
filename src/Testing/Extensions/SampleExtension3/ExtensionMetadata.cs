...
namespace SampleExtension3
{
    /// <summary>
    /// No Permissions Type defined.
    /// </summary>
    public class ExtensionMetadata : IExtensionMetadata
    {
        public string Name { get { return "SampleExtension3"; } }
        public string Description { get { return "Sample Extension 3"; } }
