...
namespace SoftinuxBase.Security.Data.EntityFramework
{
    public class PermissionRepository : RepositoryBase<Permission>, IPermissionRepository
    {
        ...
        /// <inheritdoc />
        public HashSet<KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>> AllForUser(string userId_)
        {
            IEnumerable<KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>> permissionsOfRoles =
                ...
                select new KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>(
                    SoftinuxBase.Security.Permissions.PermissionHelper.FromName(permission.Name), rolePermission.Extension);

            IEnumerable<KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>> permissionsOfUser =
                from permission in storageContext.Set<Permission>()
                ...
                select new KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>(
                    SoftinuxBase.Security.Permissions.PermissionHelper.FromName(permission.Name), userPermission.Extension);

            HashSet<KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>> allPermissions =
                new HashSet<KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string>>();

            foreach (KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string> item in permissionsOfRoles)
            {
                allPermissions.Add(item);
            }

            foreach (KeyValuePair<SoftinuxBase.Security.Permissions.Enums.Permission, string> item in permissionsOfUser)
            {
                allPermissions.Add(item);
            }
        ...
        /// <inheritdoc />
        public Permission Find(Security.Permissions.Enums.Permission permissionLevel_)
        {
